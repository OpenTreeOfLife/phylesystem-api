def includeme(config):
    ...
    config.add_route(
        ...
        "/{api_version}/push_docstore_changes/{doc_type}/{doc_id}",
    )
    config.add_route(
    ...
    config.add_route(
        "exclude_tree_from_synth", "/{api_version}/exclude_tree_from_synth"
    )
    config.add_route("create_study", "/{api_version}/study/")
    config.add_route(
        "study_CORS_preflight",
        "/{api_version}/study/{study_id}",
        request_method="OPTIONS",
    )
    config.add_route(
        "fetch_study", "/{api_version}/study/{study_id}", request_method="GET"
    )
    config.add_route(
        "fetch_study_label", "/{api_version}/study/{study_id}/", request_method="GET"
    )
    config.add_route(
        "update_study", "/{api_version}/study/{study_id}", request_method="PUT"
    )
    config.add_route(
        "delete_study", "/{api_version}/study/{study_id}", request_method="DELETE"
    )
    config.add_route("get_study_file_list", "/{api_version}/study/{study_id}/file")
    config.add_route(
        "get_study_single_file", "/{api_version}/study/{study_id}/file/{file_id}"
    )
    config.add_route(
        "get_study_external_url", "/{api_version}/study/external_url/{study_id}"
    )
    config.add_route(
        "get_study_tree",
        "/{api_version}/study/{study_id}/tree/{tree_id_with_extension}",
    )
    config.add_route(
    ...
    #
    config.add_route(
        "get_study_otu_by_id", "/{api_version}/study/{study_id}/otu/{otu_id}"
    )
    config.add_route(
        "get_study_otu_by_id_slash", "/{api_version}/study/{study_id}/otu/{otu_id}/"
    )
    ...
    config.add_route(
        "get_study_otumap_slash", "/{api_version}/study/{study_id}/otumap/"
    )
    ...
    config.add_route(
        "find_trees_in_collections", "/{api_version}/collections/find_trees"
    )
    ...
    config.add_route(
        ...
        "/{api_version}/collection/{collection_id:.*}",
        request_method="OPTIONS",
    )
    config.add_route(
        "fetch_collection",
    ...
    config.add_route(
        ...
        "/{api_version}/amendment/{amendment_id}",
        request_method="OPTIONS",
    )
    config.add_route(
        "fetch_amendment",
