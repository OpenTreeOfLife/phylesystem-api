...
rg2 = test_http_json_method(
    alt_SUBMIT_URI, "GET", data=data, expected_status=200, return_bool_data=True
)
assert rg2[0] == True
...
SUBMIT_URI = DOMAIN + "/v3/merge_docstore_changes/{s}/{scs}".format(
    s=study_id, scs=starting_commit_SHA
)
